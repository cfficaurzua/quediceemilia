...
const todoSplash = document.getElementById("todoSplash");
...
const preguntas = [
    {
        texto: "¿Qué sonido o ruido no te deja dormir por las noches?",
        respuestas: [
...
const preguntasDineroRapido = [
    {
        pregunta: "¿De qué color es normalmente la gelatina?",
        respuestas: [
            { texto: "Roja", puntaje: 38 },
            { texto: "Rosa", puntaje: 29 },
            { texto: "Celeste", puntaje: 5 },
            { texto: "Verde", puntaje: 18 },
            { texto: "Amarilla", puntaje: 20 },
            { texto: "Naranja", puntaje: 25 },
        ],
    },
    {
        pregunta: "¿Qué fruta se usa para hacer jugo?",
        respuestas: [
            { texto: "Naranja", puntaje: 40 },
            { texto: "Manzana", puntaje: 30 },
            { texto: "Plátano", puntaje: 10 },
            { texto: "Piña", puntaje: 15 },
            { texto: "Frutilla", puntaje: 20 },
        ],
    },
    {
        pregunta: "¿Qué haces antes de dormir?",
        respuestas: [
            { texto: "Cepillarme los dientes", puntaje: 35 },
            { texto: "Ver televisión", puntaje: 25 },
            { texto: "Leer", puntaje: 15 },
            { texto: "Revisar el celular", puntaje: 30 },
            { texto: "Tomar agua", puntaje: 10 },
        ],
    },
    {
        pregunta: "¿Qué usas cuando llueve?",
        respuestas: [
            { texto: "Paraguas", puntaje: 40 },
            { texto: "Impermeable", puntaje: 20 },
            { texto: "Botas", puntaje: 25 },
            { texto: "Gorro", puntaje: 10 },
            { texto: "Bolsa", puntaje: 5 },
        ],
    },
    {
        pregunta: "¿Qué haces en vacaciones?",
        respuestas: [
            { texto: "Viajar", puntaje: 45 },
            { texto: "Descansar", puntaje: 30 },
            { texto: "Ir a la playa", puntaje: 35 },
            { texto: "Leer", puntaje: 15 },
            { texto: "Ver series", puntaje: 20 },
        ],
    },
    {
        pregunta: "¿Qué objeto encuentras en una oficina?",
        respuestas: [
            { texto: "Computador", puntaje: 40 },
            { texto: "Escritorio", puntaje: 25 },
            { texto: "Silla", puntaje: 20 },
            { texto: "Teléfono", puntaje: 15 },
            { texto: "Lápiz", puntaje: 10 },
        ],
    },
];
...
function drawGame() {
    ...
    ctx.textAlign = "center";
    ctx.fillText(pregunta.texto, canvas.width / 2, 100);
